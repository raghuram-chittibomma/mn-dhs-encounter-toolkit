...
- **Annotated copy (rule highlights):** [`docs/reference/annotated/dhs_837_encounter_companion_guide_annotated.pdf`](annotated/dhs_837_encounter_companion_guide_annotated.pdf) — generated by `scripts/annotate_dhs_companion_pdf.py` (requires `pymupdf`).
- **Rule source trace table:** [`docs/RULE_SOURCE_TRACE.md`](../RULE_SOURCE_TRACE.md) — generated by `scripts/generate_rule_source_trace.py`.
...
- Used by:
  - **Validator Layer 3 (DHS encounter business rules)** — `src/mn_encounter_toolkit/validator/layer3_dhs_rules.py`:
    `L3-BILLING-TIN-REQUIRED`, `L3-BILLING-UMPI-REQUIRED`, `L3-SERVICE-FACILITY-UMPI-REQUIRED`,
    ...
    `L3-837I-CL1-REQUIRED`, `L3-837I-STATEMENT-DATES-REQUIRED`,
    `L3-SUBSCRIBER-DMG-REQUIRED`, `L3-837I-ATTENDING-UMPI-REQUIRED`,
