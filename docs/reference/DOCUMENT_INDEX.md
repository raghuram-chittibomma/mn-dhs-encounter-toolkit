...
- Used by:
  - **Validator Layer 3 (DHS encounter business rules)** — `src/mn_encounter_toolkit/validator/layer3_dhs_rules.py`:
    ...
    `L3-SENDER-ID-MATCHES-SUBMITTER`, `L3-ISA-RECEIVER-FIXED`, `L3-MEMBER-ID-EIGHT-DIGITS`,
    `L3-EPSDT-NU-WHEN-NO-REFERRAL`, `L3-VOID-REF-F8-ONLY`, `L3-DIAGNOSIS-PRINCIPAL-QUALIFIER`, `L3-DIAGNOSIS-SUBSEQUENT-QUALIFIER`,
