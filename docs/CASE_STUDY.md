...
2. **Validate** against four independent layers (56 rules), with DHS companion-guide citations on Layer 3
...
- **56 validation rules** — searchable in UI and [`VALIDATION_LAYERS.md`](VALIDATION_LAYERS.md)
